...
public class AutoConstants {
	...
	public static void updatePreferences() {
		...
		AUTO_DRIVE_TO_INCH_FOWRD = Robot.prefs.getDouble("AUTO_DRIVE_TO_INCH_FOWRD", 24);
		...
		RIGHT_FORWARD_RED = Robot.prefs.getDouble("RIGHT_FORWARD_RED", 68);
		RIGHT_FORWARD_BLUE = Robot.prefs.getDouble("RIGHT_FORWARD_BLUE", 74);
